...
public class AndroidGeolocationModule2 extends ReactContextBaseJavaModule implements LifecycleEventListener, BDLocationListener {
  ...
  public AndroidGeolocationModule2(ReactApplicationContext reactContext) {
    super(reactContext);
