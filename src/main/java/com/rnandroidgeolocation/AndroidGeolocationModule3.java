...
public class AndroidGeolocationModule3 extends ReactContextBaseJavaModule implements LifecycleEventListener, BDLocationListener {
  ...
  public AndroidGeolocationModule3(ReactApplicationContext reactContext) {
    super(reactContext);
